      ...
      <form action={createCategory} className={styles.form}>
        ...
        <div className={styles.checkboxGroup}>
          ...
          <div className={styles.labelContainer}>
            ...
            <p>
              Marque se as despesas daqui serão pagas por outra pessoa (ex:
